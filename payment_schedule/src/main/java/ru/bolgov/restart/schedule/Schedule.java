...
/**
 * Класс вычисляет и хранит график платежей по кредиту, исходя из начальных данных
 */
...
public class Schedule {
    ...
    public BigDecimal calculateTotalPercent(){
        ...
        for(MonthPay payment : payments){
            totalPercent = totalPercent.add(payment.getPercent());
        }
        return totalPercent;
    }
    ...
    private void calculateSchedule(){
        if(isAnnuityPayment){
            ...
            for (int i = 0; i < creditTerm; i++){
                ...
                MonthPay monthPay = new MonthPay(anotherMonths, principal, percentPay, payment, balance);
