...
import ru.sberbank.coursework.bank_answer.data.Client;
import ru.sberbank.coursework.bank_answer.data.Loan;
import ru.sberbank.coursework.bank_answer.data.Loan_Offer;
import ru.sberbank.coursework.bank_answer.data.Loan_request;
...
public class RequestController {
    private String POST_URL1 = "http://localhost:8086/bank_answer/json_in";
