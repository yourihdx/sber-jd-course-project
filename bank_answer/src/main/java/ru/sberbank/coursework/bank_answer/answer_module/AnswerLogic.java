...
import ru.sberbank.coursework.bank_answer.data.AnswerList;
import ru.sberbank.coursework.bank_answer.data.Loan_Answer;
...
public class AnswerLogic {
    ...
    private final Logger logger = LoggerFactory.getLogger(AnswerLogic.class);
